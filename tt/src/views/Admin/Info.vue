<template>
  ...
  <page-header-wrapper :title="false" :content="$t('form.basic-form.basic.description')">
	...
	<a-select v-decorator="[Name, {initialValue:'' }]" :options="banner" placeholder="请选择管理员" /> 
</a-form-item>
    <a-form-item
          :label="密码"
          :labelCol="{lg: {span: 7}, sm: {span: 7}}"
          :wrapperCol="{lg: {span: 10}, sm: {span: 17} }"> 
	<a-select v-decorator="[Password, {initialValue:'value' }]" :options="[{"label":"label","value":"value"},{"label":"label1","value":"value1"}]" placeholder="请选择密码" /> 
</a-form-item>
        <a-form-item
          :wrapperCol="{ span: 24 }"
